...
insert into osm_roads select id,tags->'highway',tags->'name',tags->'lanes',tags->'maxspeed',tags->'toll',linestring from ways where exist(tags,'highway') and ST_NPoints(linestring) >= 2;
CREATE INDEX roads_the_geom_idx ON osm_roads USING gist (the_geom);
