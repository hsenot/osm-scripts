...
ALTER table building_project DROP CONSTRAINT building_project_building_fk;

DROP INDEX buildings_the_geom_idx;
ALTER TABLE osm_buildings DROP CONSTRAINT osm_building_pk;
...
ALTER TABLE osm_buildings ADD CONSTRAINT osm_building_pk PRIMARY KEY(osm_id);
CREATE INDEX buildings_the_geom_idx ON osm_buildings USING gist (the_geom);
CLUSTER osm_buildings USING buildings_the_geom_idx;

-- re-instating the foreign key to buildings
ALTER TABLE building_project ADD CONSTRAINT building_project_building_fk FOREIGN KEY (id_building) REFERENCES building (osm_id);
