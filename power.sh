...
###bzcat /opt/data/australia.osm.bz2 | ./osmosis --read-xml file=- --tf accept-ways 'power=*' --used-node --tf accept-nodes 'power=*' --write-pgsql-dump directory=/opt/data/pgsqldump
