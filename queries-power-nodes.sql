...
delete from osm_power_generator where osm_id in (select id from nodes where exist(tags,'power') and tags->'power'='generator');

insert into osm_power_generator
select id, tags->'power', tags->'name', coalesce(tags->'generator:source',tags->'power_source'),tags->'generator:method',tags->'generator:output:electricity',coalesce(tags->'area','no'),tags->'operator',tags->'source',geom
from nodes where exist(tags,'power') and tags->'power'='generator';

delete from osm_power_substation where osm_id in (select id from nodes where exist(tags,'power') and tags->'power' in ('station','sub_station') );

insert into osm_power_substation
select id, tags->'power', tags->'name', tags->'operator',tags->'voltage',tags->'source',geom
from nodes where exist(tags,'power') and tags->'power' in ('station','sub_station') ;
